...
var Slider = function (_React$Component) {
    ...
    _createClass(Slider, [{
        ...
        key: 'sliderStyleVertical',
        value: function sliderStyleVertical(classname) {
            var items = document.querySelector(classname);
            var itemHeight = items ? items.offsetHeight : 0;
            var shift = itemHeight * this.state.currentPosition;
